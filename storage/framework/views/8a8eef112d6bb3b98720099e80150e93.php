        ...
        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="flex flex-1 items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold"><?php echo e(Auth::user()->name); ?></h2>
                        <p class="text-blue-100">Instructor</p>
                        <p class="text-blue-200 text-sm"><?php echo e(Auth::user()->email); ?></p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center">
                            <span id="name-display" class="flex-1 px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-900"><?php echo e(Auth::user()->name ?? 'Not set'); ?></span>
                        </div>
                        <div id="name-edit" class="hidden flex items-center">
                            <input type="text" id="name-input" value="<?php echo e(Auth::user()->name ?? ''); ?>" class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <div id="email-edit" class="hidden flex items-center">
                            <input type="email" id="email-input" value="<?php echo e(Auth::user()->email ?? ''); ?>" class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <div id="phone-edit" class="hidden flex items-center">
                            <input type="tel" id="phone-input" value="<?php echo e(Auth::user()->phone ?? ''); ?>" class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views/Instructor/partials/profile-modal.blade.php ENDPATH**/ ?>