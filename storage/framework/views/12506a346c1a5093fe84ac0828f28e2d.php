        ...
        <div class="overflow-x-auto">
            ...
            <table id="pendingTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr data-enrollment-id="<?php echo e($enrollment->id); ?>">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e(\Illuminate\Support\Str::title($enrollment->last_name)); ?>, <?php echo e(\Illuminate\Support\Str::title($enrollment->first_name)); ?> <?php echo e(\Illuminate\Support\Str::title($enrollment->middle_name)); ?> <?php echo e(\Illuminate\Support\Str::title($enrollment->suffix_name)); ?></div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php if($enrollment->is_re_enrollment && $enrollment->re_enrollment_date): ?>
                                <?php echo e(\Carbon\Carbon::parse($enrollment->re_enrollment_date)->format('F d, Y')); ?>

                                <span class="text-xs text-blue-600">(Re-enrolled)</span>
                            <?php else: ?>
                                <?php echo e(\Carbon\Carbon::parse($enrollment->created_at)->format('F d, Y')); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                ...
                                <?php if($enrollment->is_re_enrollment): ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button onclick="openModal(<?php echo e($enrollment->id); ?>)" class="text-blue-600 hover:text-blue-900">View Details</button>
                        </td>
                    </tr>
                    <!-- Details Modal -->
                    <div id="studentDetailsModal-<?php echo e($enrollment->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto h-full w-full z-50" onclick="closeStudentDetailsModalOnOutside(event, '<?php echo e($enrollment->id); ?>')">
                        <div class="relative top-10 mx-auto p-0 border w-full max-w-4xl shadow-lg rounded-lg bg-white max-h-[90vh] overflow-y-auto modal-scrollbar" onclick="event.stopPropagation()">
                            ...
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <button onclick="closeModal(<?php echo e($enrollment->id); ?>)" class="text-gray-400 hover:text-gray-600">
                            ...
                            <div class="p-6">
                                ...
                                <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 mr-6">
                                                    <?php if($enrollment->photo): ?>
                                                <img src="<?php echo e(asset('storage/' . $enrollment->photo)); ?>" alt="Student Photo" class="w-20 h-20 rounded-full object-cover border-2 border-gray-200">
                                                    <?php elseif($enrollment->user && $enrollment->user->photo): ?>
                                                <img src="<?php echo e(asset('storage/' . $enrollment->user->photo)); ?>" alt="User Photo" class="w-20 h-20 rounded-full object-cover border-2 border-gray-200">
                                                    <?php else: ?>
                                            ...
                                            <h2 class="text-2xl font-semibold text-gray-900 mb-1">
                                                <?php echo e(\Illuminate\Support\Str::title($enrollment->last_name)); ?>, <?php echo e(\Illuminate\Support\Str::title($enrollment->first_name)); ?> <?php echo e(\Illuminate\Support\Str::title($enrollment->middle_name)); ?> <?php echo e(\Illuminate\Support\Str::title($enrollment->suffix_name)); ?>

                                            </h2>
                                            <p class="text-gray-600 mb-1"><?php echo e($enrollment->email); ?></p>
                                            <p class="text-sm text-gray-500"><?php echo e($enrollment->program->name ?? 'No Program'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            ...
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->phone ?? 'N/A'); ?></span>
                                                </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Status:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->status ?? 'Pending Review'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            ...
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->birthdate); ?></span>
                                                </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Age:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->age); ?></span>
                                                </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Gender:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->gender); ?></span>
                                            </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Citizenship:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->citizenship ?? 'N/A'); ?></span>
                                        </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Religion:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->religion ?? 'N/A'); ?></span>
                                    </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Submission Date:</span>
                                            <span class="text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($enrollment->created_at)->format('M d, Y')); ?></span>
                                </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            ...
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->place_of_birth ?? 'N/A'); ?></span>
                                                </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Civil Status:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->civil_status ?? 'N/A'); ?></span>
                                                </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Father's Name:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->father_name ?? 'N/A'); ?></span>
                                            </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Mother's Name:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->mother_name ?? 'N/A'); ?></span>
                                        </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Guardian:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->guardian ?? 'N/A'); ?></span>
                                                </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Guardian Contact:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->guardian_contact ?? 'N/A'); ?></span>
                                                </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Parent Consent:</span>
                                            <span class="text-sm text-gray-900">
                                                    <?php if($enrollment->parent_consent): ?>
                                                    <a href="<?php echo e(asset('storage/' . $enrollment->parent_consent)); ?>" target="_blank" class="text-blue-600 hover:text-blue-800 hover:underline">
                                                        View Document
                                                        </a>
                                                    <?php else: ?>
                                ...
                                <div class="mb-8 pt-6 border-t border-gray-200">
                                    ...
                                    <div class="flex space-x-4 px-4">
                                        <button onclick="confirmApprove(<?php echo e($enrollment->id); ?>)" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">
                                            Approve Enrollment
                                        </button>
                                        <button onclick="showRejectReason(<?php echo e($enrollment->id); ?>)" class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors">
                                            Reject Enrollment
                                        </button>
                                    </div>
                                    
                                    <div id="rejectReasonBox-<?php echo e($enrollment->id); ?>" class="mt-4 hidden">
                                        <div class="bg-red-50 border border-red-200 rounded-md p-4">
                                            <label for="rejectReasonInput-<?php echo e($enrollment->id); ?>" class="block text-sm font-medium text-red-700 mb-2">Rejection Reason</label>
                                            <textarea id="rejectReasonInput-<?php echo e($enrollment->id); ?>" rows="3" class="w-full border border-red-300 rounded-md py-2 px-3 focus:ring-2 focus:ring-red-500 focus:border-red-500" placeholder="Please provide a reason for rejecting this enrollment..."></textarea>
                                            <button onclick="confirmReject(<?php echo e($enrollment->id); ?>)" class="mt-3 px-4 py-2 bg-red-700 text-white rounded-md hover:bg-red-800 transition-colors">
                                                Submit Rejection
                                            </button>
                                        </div>
                                    </div>
            ...
            <table id="approvedTable" class="min-w-full divide-y divide-gray-200 hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $approvedEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 rounded-full overflow-hidden">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($enrollment->program->name ?? 'No Program'); ?></div>
                            <div class="text-sm text-gray-500">Batch #<?php echo e($enrollment->batch_number); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e(\Carbon\Carbon::parse($enrollment->created_at)->format('F d, Y')); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($enrollment->approved_at ? \Carbon\Carbon::parse($enrollment->approved_at)->format('F d, Y') : 'N/A'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button onclick="openModal(<?php echo e($enrollment->id); ?>, 'approved')" class="text-blue-600 hover:text-blue-900">View Details</button>
                        </td>
                    </tr>
                    <!-- Approved Details Modal -->
                    <div id="studentDetailsModal-approved-<?php echo e($enrollment->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto h-full w-full z-50" onclick="closeStudentDetailsModalOnOutside(event, 'approved-<?php echo e($enrollment->id); ?>')">
                        <div class="relative top-10 mx-auto p-0 border w-full max-w-4xl shadow-lg rounded-lg bg-white max-h-[90vh] overflow-y-auto modal-scrollbar" onclick="event.stopPropagation()">
                            <!-- Simple Header -->
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <button onclick="closeModal(<?php echo e($enrollment->id); ?>, 'approved')" class="text-gray-400 hover:text-gray-600">
                                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                        </svg>
                                    </button>
                            ...
                            <div class="p-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Status:</span>
                                            <select id="statusSelect-approved-<?php echo e($enrollment->id); ?>" class="text-sm text-gray-900 border-none bg-transparent focus:ring-0 focus:border-none">
                                                <option value="approved" <?php echo e(($enrollment->status ?? 'approved') == 'approved' ? 'selected' : ''); ?>>Approved</option>
                                                <option value="enrolled" <?php echo e(($enrollment->status ?? 'approved') == 'enrolled' ? 'selected' : ''); ?>>Enrolled</option>
                                            </select>
                                        </div>
                                    </div>
                                        </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="flex justify-between py-2 border-b border-gray-100">
                                            ...
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->approved_at ? \Carbon\Carbon::parse($enrollment->approved_at)->format('M d, Y') : 'N/A'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-end space-x-4 py-4">
                                    <button onclick="saveStatus(<?php echo e($enrollment->id); ?>, 'approved')" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Save Changes</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table id="rejectedTable" class="min-w-full divide-y divide-gray-200 hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $rejectedEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 rounded-full overflow-hidden">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($enrollment->rejected_at ? \Carbon\Carbon::parse($enrollment->rejected_at)->format('F d, Y') : 'N/A'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($enrollment->rejection_reason ?? 'No reason provided'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button onclick="openModal(<?php echo e($enrollment->id); ?>, 'rejected')" class="text-blue-600 hover:text-blue-900">View Details</button>
                        </td>
                    </tr>
                    <!-- Rejected Details Modal -->
                    <div id="studentDetailsModal-rejected-<?php echo e($enrollment->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto h-full w-full z-50" onclick="closeStudentDetailsModalOnOutside(event, 'rejected-<?php echo e($enrollment->id); ?>')">
                        <div class="relative top-10 mx-auto p-0 border w-full max-w-4xl shadow-lg rounded-lg bg-white max-h-[90vh] overflow-y-auto modal-scrollbar" onclick="event.stopPropagation()">
                            <!-- Simple Header -->
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <button onclick="closeModal(<?php echo e($enrollment->id); ?>, 'rejected')" class="text-gray-400 hover:text-gray-600">
                                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                        </svg>
                                    </button>
                            ...
                            <div class="p-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Status:</span>
                                            <span class="text-sm text-red-600 font-medium"><?php echo e($enrollment->status ?? 'Rejected'); ?></span>
                                        </div>
                                    </div>
                                        </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            ...
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->rejected_at ? \Carbon\Carbon::parse($enrollment->rejected_at)->format('M d, Y') : 'N/A'); ?></span>
                                        </div>
                                        <div class="flex items-center py-2 border-b border-gray-100">
                                            <span class="text-sm font-medium text-gray-500 mr-3">Rejection Reason:</span>
                                            <span class="text-sm text-gray-900"><?php echo e($enrollment->rejection_reason ?? 'No reason provided'); ?></span>
                                    </div>
                                        </div>
                                </div>
            ...
            <div class="bg-gray-50 px-6 py-3 flex items-center justify-between border-t border-gray-200">
                <div class="text-sm text-gray-500" id="paginationNote">
                    <?php echo e($pendingEnrollments->total()); ?> total pending entries
                </div>
                <div class="flex space-x-2">
                    <?php echo e($pendingEnrollments->appends(['pending_page' => $pendingEnrollments->currentPage(), 'approved_page' => $approvedEnrollments->currentPage(), 'rejected_page' => $rejectedEnrollments->currentPage()])->links()); ?>
...
<div id="qrDateModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden px-2" onclick="closeQrDateModalOnOutside(event)">
    ...
    const tabCounts = {
        pending: <?php echo e($pendingEnrollments->total()); ?>,
        approved: <?php echo e($approvedEnrollments->total()); ?>,
        rejected: <?php echo e($rejectedEnrollments->total()); ?>
    ...
    async function generateQrCodes() {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("admin.qr-codes.generate")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
    ...
    async function loadQrHistory() {
        ...
        try {
            console.log('Loading QR history from:', '<?php echo e(route("admin.qr-codes.by-date")); ?>');
            
            const response = await fetch('<?php echo e(route("admin.qr-codes.by-date")); ?>', {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    async function loadQrCodesForDate(date) {
        ...
        try {
            const response = await fetch(`<?php echo e(route("admin.qr-codes.for-date")); ?>?date=${date}`, {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views/Admin/enrollment_management.blade.php ENDPATH**/ ?>