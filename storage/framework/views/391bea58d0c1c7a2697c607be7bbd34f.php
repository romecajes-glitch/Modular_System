...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'add-program','show' => false,'maxWidth' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'add-program','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => 'md']); ?>
                            <div class="p-6">
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'add-schedule','show' => false,'maxWidth' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'add-schedule','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => 'md']); ?>
                            <div class="p-6">
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'edit-program','show' => false,'maxWidth' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'edit-program','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => 'md']); ?>
                            <div class="p-6">
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'edit-schedule','show' => false,'maxWidth' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'edit-schedule','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => 'md']); ?>
                            <div class="p-6">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white border border-gray-200 rounded-lg overflow-hidden">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($program->status === 'inactive' ? 'bg-gray-50 opacity-60' : 'hover:bg-gray-50 transition-colors'); ?>">
                                        <td class="px-6 py-4 whitespace-nowrap <?php echo e($program->status === 'inactive' ? 'text-gray-500' : 'text-gray-900'); ?>">
                                            <div class="flex items-center">
                                                <div class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                                                    <i class="fas fa-graduation-cap text-blue-600 text-sm"></i>
                                                </div>
                                                <div>
                                                    <div class="text-sm font-medium"><?php echo e($program->name); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap <?php echo e($program->status === 'inactive' ? 'text-gray-500' : 'text-gray-900'); ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap <?php echo e($program->status === 'inactive' ? 'text-gray-500' : 'text-gray-900'); ?>">
                                            <span class="text-sm font-semibold text-emerald-600">₱<?php echo e(number_format($program->registration_fee ?? 0, 2)); ?></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap <?php echo e($program->status === 'inactive' ? 'text-gray-500' : 'text-gray-900'); ?>">
                                            <span class="text-sm font-semibold text-blue-600">₱<?php echo e(number_format($program->price_per_session ?? 0, 2)); ?></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap <?php echo e($program->status === 'inactive' ? 'text-gray-500' : 'text-gray-900'); ?>">
                                            <span class="text-sm font-bold text-purple-600">₱<?php echo e(number_format(($program->price_per_session ?? 0) * (is_numeric($program->duration) ? (int)$program->duration : (preg_match('/(\d+)/', $program->duration, $matches) ? (int)$matches[1] : 0)), 2)); ?></span>
                                        </td>
                                        <td class="px-6 py-4 <?php echo e($program->status === 'inactive' ? 'text-gray-500' : 'text-gray-900'); ?>">
                                            <div class="text-sm max-w-xs truncate" title="<?php echo e($program->description); ?>"><?php echo e($program->description); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($program->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                <i class="fas <?php echo e($program->status === 'active' ? 'fa-check-circle' : 'fa-times-circle'); ?> mr-1"></i>
                                                <?php echo e(ucfirst($program->status ?? 'active')); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200" title="Edit" onclick="openEditProgramModal(<?php echo e($program->id); ?>)">
                                                    <i class="fas fa-edit mr-1"></i>Edit
                                                </button>
                                                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white <?php echo e($program->status === 'active' ? 'bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700' : 'bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700'); ?> focus:outline-none focus:ring-2 focus:ring-offset-2 <?php echo e($program->status === 'active' ? 'focus:ring-yellow-500' : 'focus:ring-green-500'); ?> transition-all duration-200"
                                                        title="<?php echo e($program->status === 'active' ? 'Deactivate' : 'Activate'); ?>"
                                                        onclick="toggleProgramStatus(<?php echo e($program->id); ?>, '<?php echo e($program->name); ?>', '<?php echo e($program->status); ?>')">
                                                    <i class="fas <?php echo e($program->status === 'active' ? 'fa-pause' : 'fa-play'); ?> mr-1"></i><?php echo e($program->status === 'active' ? 'Deactivate' : 'Activate'); ?>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="text-sm font-medium text-gray-900"><?php echo e($schedule->program?->name ?? 'N/A'); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                <i class="fas fa-calendar-day mr-1"></i><?php echo e($schedule->day); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div class="flex items-center">
                                                ...
                                                <span class="font-medium"><?php echo e($schedule->start_time); ?> - <?php echo e($schedule->end_time); ?></span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <button class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200" title="Settings" onclick="openEditScheduleModal(<?php echo e($schedule->id); ?>)">
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views/Admin/schedule.blade.php ENDPATH**/ ?>