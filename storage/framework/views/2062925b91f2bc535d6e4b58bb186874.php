...
<div class="flex-1 overflow-y-auto">
    <ul class="py-2 space-y-1">
        <!-- Dashboard -->
        <li style="cursor: pointer;" id="dashboardNav" data-url="<?php echo e(route('admin.dashboard')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/dashboard') ? 'active-nav' : ''); ?>">
        ...
        <li style="cursor: pointer;" id="enrollmentNav" data-url="<?php echo e(route('admin.enrollments')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/enrollments') ? 'active-nav' : ''); ?>">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <!-- Enrolled Students -->
        <li style="cursor: pointer;" id="studentsNav" data-url="<?php echo e(route('admin.enrolled.students')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/enrolled-students') ? 'active-nav' : ''); ?>">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <!-- Attendance -->
        <li style="cursor: pointer;" id="attendanceNav" data-url="<?php echo e(route('admin.attendance')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/attendance*') ? 'active-nav' : ''); ?>">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <!-- User Management -->
        <li style="cursor: pointer;" id="userNav" data-url="<?php echo e(route('admin.users')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/users') ? 'active-nav' : ''); ?>">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <!-- Reports / Monitoring -->
        <li style="cursor: pointer;" id="reportNav" data-url="<?php echo e(route('admin.reports')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/reports') ? 'active-nav' : ''); ?>">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <li style="cursor: pointer;" id="scheduleNav" data-url="<?php echo e(route('admin.schedules')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/schedules') ? 'active-nav' : ''); ?>">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <!-- Certificates -->
        <li style="cursor: pointer;" id="certificateNav" data-url="<?php echo e(route('admin.certificates')); ?>" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] <?php echo e(request()->is('admin/certificates') ? 'active-nav' : ''); ?>">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
