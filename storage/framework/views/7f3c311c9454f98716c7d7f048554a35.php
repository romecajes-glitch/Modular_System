                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200" id="pendingTable">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr data-name="<?php echo e($enrollment->user->name); ?>" data-id="<?php echo e($enrollment->user->student_id); ?>" data-program="<?php echo e($enrollment->program->name ?? 'No Program'); ?>" data-year="<?php echo e(\Carbon\Carbon::parse($enrollment->completion_date)->year); ?>" data-issued="false">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <?php if($enrollment->user && $enrollment->user->photo): ?>
                                                        <img src="<?php echo e(asset('storage/' . $enrollment->user->photo)); ?>" alt="Photo" class="h-10 w-10 rounded-full object-cover">
                                                    <?php else: ?>
                                                ...
                                                <div class="ml-4">
                                                    ...
                                                    <div class="text-sm text-gray-500"><?php echo e($enrollment->user->email ?? 'N/A'); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($enrollment->program->name ?? 'No Program'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e($enrollment->completion_date ? \Carbon\Carbon::parse($enrollment->completion_date)->format('M d, Y') : 'N/A'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                <input type="checkbox" class="certificate-checkbox" data-id="<?php echo e($enrollment->user->student_id); ?>" class="form-checkbox h-4 w-4 text-blue-600">
                                            </div>
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views/Instructor/certificate.blade.php ENDPATH**/ ?>