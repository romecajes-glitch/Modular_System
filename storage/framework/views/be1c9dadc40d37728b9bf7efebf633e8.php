...
<body class="bg-gray-100 font-sans">
                                    ...
                                    <tr class="hover:bg-gray-50" data-program-id="<?php echo e($enrollment->program_id); ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <?php
                                                ...
                                                // Same logic as admin - only check payment verification, not existing attendance
                                                $canMarkAttendance = ($referenceNumber || $orNumber) && $amountPaid && $amountPaid > 0;
    ...
    <script>
        ...
        function saveOrNumber(enrollmentId, newValue) {
            ...
            fetch('<?php echo e(route("instructor.attendance.update-amount")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
