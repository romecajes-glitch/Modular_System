            ...
            <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="dateRangeSelect" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                    <option value="7" <?php echo e(request('date_range') == '7' ? 'selected' : ''); ?>>Last 7 days</option>
                                    <option value="30" <?php echo e(request('date_range') == '30' ? 'selected' : ''); ?>>Last 30 days</option>
                                    <option value="90" <?php echo e(request('date_range') == '90' ? 'selected' : ''); ?>>Last 90 days</option>
                                    <option value="180" <?php echo e(request('date_range') == '180' ? 'selected' : ''); ?>>Last 6 months</option>
                                    <option value="365" <?php echo e(request('date_range') == '365' ? 'selected' : ''); ?>>Last year</option>
                                    <option value="all" <?php echo e(request('date_range') == 'all' || !request('date_range') ? 'selected' : ''); ?>>All time</option>
                                    <option value="custom" <?php echo e(request('date_range') == 'custom' ? 'selected' : ''); ?>>Custom range</option>
                                </select>
                            </div>
                            <div id="customDateRange" class="<?php echo e(request('date_range') == 'custom' ? '' : 'hidden'); ?>">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Custom Date Range</label>
                                <div class="flex items-center space-x-2">
                                    <input type="date" id="startDate" value="<?php echo e(request('start_date')); ?>" class="flex-1 px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                    <span class="text-gray-500">to</span>
                                    <input type="date" id="endDate" value="<?php echo e(request('end_date')); ?>" class="flex-1 px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    ...
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold mt-2"><?php echo e(number_format($totalEnrollments)); ?></p>
                    ...
                    <div class="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold mt-2 leading-tight break-words" title="<?php echo e($mostPopularProgram ? $mostPopularProgram->program->name : 'N/A'); ?>">
                                    <?php echo e($mostPopularProgram ? $mostPopularProgram->program->name : 'N/A'); ?>

                                </p>
                                <p class="text-xs opacity-75 mt-1"><?php echo e($mostPopularProgram ? $mostPopularProgram->count : 0); ?> students</p>
                            </div>
                    ...
                    <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold mt-2"><?php echo e(number_format($totalCertificates)); ?></p>
                    ...
                    <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold mt-2"><?php echo e(number_format($totalQrCodes)); ?></p>
                                <p class="text-xs opacity-75 mt-1"><?php echo e($usedQrCodes); ?> used (<?php echo e($qrCodeUsageRate); ?>%)</p>
                            </div>
                            <div class="w-12 h-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                    ...
                    <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-2xl font-bold mt-2">₱<?php echo e(number_format($totalOnlinePayments, 0)); ?></p>
                                <div class="text-xs opacity-75 mt-2 space-y-1">
                                    <div class="flex justify-between">
                                        <span>Registration:</span>
                                        <span class="font-medium">₱<?php echo e(number_format($registrationPayments, 2)); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span>Session Fee:</span>
                                        <span class="font-medium">₱<?php echo e(number_format($sessionPayments, 2)); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="w-12 h-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center flex-shrink-0 ml-2">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const enrollmentData = <?php echo json_encode($enrollmentByWeek, 15, 512) ?>;
                        ...
                        // Enrollments by Program Chart
                        const programData = <?php echo json_encode($programEnrollments, 15, 512) ?>;
                        const programLabels = programData.map(item => {
                            // Get program name from the program_id
                            const programNames = <?php echo json_encode($programs->pluck('name', 'id'), 512) ?>;
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $userActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mr-3">
                                                <span class="text-white text-sm font-medium"><?php echo e(substr($activity->name, 0, 1)); ?></span>
                                            </div>
                                            <span class="font-medium text-gray-900"><?php echo e($activity->name); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e($activity->updated_at->format('M d, Y H:i')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($activity->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                            <div class="w-1.5 h-1.5 rounded-full <?php echo e($activity->status === 'active' ? 'bg-green-400' : 'bg-yellow-400'); ?> mr-1.5"></div>
                        ...
                        <?php if($userActivities->hasPages()): ?>
                        <div class="bg-gray-50 px-6 py-3 border-t border-gray-200">
                            <?php echo e($userActivities->links()); ?>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $paymentLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-8 h-8 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center mr-3">
                                                <span class="text-white text-sm font-medium"><?php echo e(substr($payment->student->name ?? 'N', 0, 1)); ?></span>
                                            </div>
                                            <span class="font-medium text-gray-900"><?php echo e($payment->student->name ?? 'N/A'); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-lg font-semibold text-emerald-600">₱<?php echo e(number_format($payment->amount, 2)); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="space-y-1">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($payment->session_count > 0 ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'); ?>">
                                                <i class="fas <?php echo e($payment->session_count > 0 ? 'fa-calendar-check' : 'fa-user-plus'); ?> mr-1"></i>
                                                <?php echo e($payment->session_count > 0 ? 'Session Payment' : 'Registration Fee'); ?>

                                            </span>
                                            <div class="text-xs text-gray-500">
                                                <i class="fas fa-credit-card mr-1"></i><?php echo e(ucfirst($payment->payment_method)); ?>
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views/Admin/reports.blade.php ENDPATH**/ ?>