        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 mb-8 overflow-hidden">
            ...
            <?php $__currentLoopData = $availableSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('admin.attendance.records', ['program_id' => $selectedProgram, 'session_number' => $session])); ?>"
                           class="inline-flex items-center px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 <?php echo e($selectedSession == $session ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 hover:text-gray-900'); ?>">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Session <?php echo e($selectedSession); ?> - <?php echo e($attendanceRecords->count()); ?> students</p>
                            </div>
                        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $attendanceRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10 rounded-full overflow-hidden mr-3">
                                                <?php if($record->enrollment->photo): ?>
                                                    <img src="<?php echo e(asset('storage/' . $record->enrollment->photo)); ?>" class="h-10 w-10 object-cover rounded-full" alt="Student Photo" />
                                                <?php elseif($record->enrollment->user && $record->enrollment->user->photo): ?>
                                                    <img src="<?php echo e(asset('storage/' . $record->enrollment->user->photo)); ?>" class="h-10 w-10 object-cover rounded-full" alt="Student Photo" />
                                                <?php else: ?>
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($record->enrollment->full_name); ?></div>
                                            </div>
                                        </div>
                            </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php if($record->start_time && $record->end_time): ?>
                                    ...
                                    <?php echo e(\Carbon\Carbon::parse($record->start_time)->format('g:i A') . ' - ' . \Carbon\Carbon::parse($record->end_time)->format('g:i A')); ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-700">
                                            <?php if(isset($record->marked_by_display)): ?>
                                                <?php if($record->marked_by_display === 'System'): ?>
                                                ...
                                                <?php else: ?>
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                        ...
                                                        <?php echo e($record->marked_by_display); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            <?php if(isset($record->payment_amount_display)): ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                                                    </svg>
                                                    ₱<?php echo e(number_format($record->payment_amount_display, 2)); ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-700">
                                            <?php if(isset($record->reference_number_display) && $record->reference_number_display !== 'N/A'): ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 font-mono">
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                                    </svg>
                                                    <?php echo e($record->reference_number_display); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-semibold text-gray-900"><?php echo e($instructor); ?></p>
