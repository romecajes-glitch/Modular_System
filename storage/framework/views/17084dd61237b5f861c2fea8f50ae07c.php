    ...
    <div class="flex h-screen overflow-hidden">
            ...
            <div class="p-6">
                ...
                <?php if(session('success')): ?>
                    <div id="floatingSuccess" class="floating-notification success" style="display:none;">
                        ...
                        <span id="floatingSuccessMessage"><?php echo e(session('success')); ?></span>
                ...
                <?php if(session('error')): ?>
                    <div id="floatingError" class="floating-notification error" style="display:none;">
                        ...
                        <span id="floatingErrorMessage"><?php echo e(session('error')); ?></span>
                    ...
                    <div class="border-b border-gray-200">
                        ...
                        <div class="border-b border-gray-200 bg-gray-50 relative">
                            ...
                            <div class="session-tabs-container">
                                <nav class="session-tabs-nav" id="sessionTabs" data-session1-count="<?php echo e($session1StudentCount ?? 0); ?>">
                                    <?php
                                    ...
                                    <button class="session-tab <?php echo e($i === $currentSession ? 'active-tab border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> py-3 px-4 text-center border-b-2 font-medium text-xs" data-session="<?php echo e($i); ?>">
                                        Session <?php echo e($i); ?>

                                    </button>
                                    <?php endfor; ?>
                                    <button class="session-tab <?php echo e($currentSession === $sessionCount + 1 ? 'active-tab border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> py-3 px-4 text-center border-b-2 font-medium text-xs" data-session="<?php echo e($sessionCount + 1); ?>">
                                        Extension
                                    </button>
                                </nav>
                            </div>
                        ...
                        <!-- Attendance Table -->
                        <form id="attendanceForm" action="<?php echo e(route('admin.attendance.save')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-gray-50" data-program-id="<?php echo e($enrollment->program_id); ?>">
                                                ...
                                                <?php if($isEditable): ?>
                                                    <div class="flex items-center">
                                                        ...
                                                        <input type="number" 
                                                               ...
                                                               value="<?php echo e($amountPaid); ?>" 
                                                               min="0" 
                                                               step="0.01"
                                                               data-student-id="<?php echo e($student->id); ?>"
                                                               data-session="<?php echo e($currentSession); ?>"
                                                               onchange="updateAmountPaid(this)">
                                                    </div>
                                                <?php elseif($amountPaid): ?>
                                                    <span class="text-sm font-medium text-gray-900">₱<?php echo e(number_format($amountPaid, 2)); ?></span>
                                                <?php else: ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                ?>
                                                <?php if($eligibility['payment_status'] === 'paid' && $hasPaymentVerification): ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php if($isExtensionSession): ?>
                                                    Extension <?php echo e($currentSession); ?> of <?php echo e($eligibility['paid_sessions'] ?? 0); ?>

                                                <?php else: ?>
                                                    Session <?php echo e($currentSession); ?> of <?php echo e($eligibility['paid_sessions'] ?? 0); ?>
        ...
        <script>
            ...
            function updateAmountPaid(inputElement) {
                ...
                fetch('<?php echo e(route("admin.attendance.update-amount")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                ...
                if (successMessage) {
                    ...
                    if (completedMatch) {
                        ...
                        viewAllBtn.addEventListener('click', function() {
                            window.location.href = "<?php echo e(route('admin.certificates')); ?>";
                        });
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views/Admin/attendance.blade.php ENDPATH**/ ?>