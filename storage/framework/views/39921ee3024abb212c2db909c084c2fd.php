        ...
        <div class="content-area flex-1 overflow-y-auto">
            ...
            <div class="p-6">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-700 rounded-xl p-6 text-white mb-6 shadow-lg">
                    <h2 class="text-2xl font-bold mb-2">Welcome back, <?php echo e(explode(' ', $userName)[0]); ?>!</h2>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <?php if($assignedPrograms->count() > 0): ?>
                                <p class="text-indigo-100 mb-2">You are assigned to <?php echo e($totalPrograms); ?> program<?php echo e($totalPrograms !== 1 ? 's' : ''); ?>:</p>
                                <div class="space-y-3">
                                    <?php $__currentLoopData = $assignedPrograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="bg-white/20 p-3 rounded-lg">
                                            <h4 class="font-semibold"><?php echo e($program->name); ?></h4>
                                            <p class="text-sm"><?php echo e($program->description); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php else: ?>
                                <p class="text-indigo-100">You are assigned to <?php echo e($totalPrograms); ?> program<?php echo e($totalPrograms !== 1 ? 's' : ''); ?></p>
                            <?php endif; ?>
                            <div class="mt-2 text-sm">
                                <span class="bg-white/20 px-2 py-1 rounded">Total Sessions Today: <?php echo e($totalSessionsToday); ?></span>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 items-stretch">
                        ...
                        <div class="flex-grow">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-medium"><?php echo e($enrolledStudentsCount); ?></span>
                                </div>
                            </div>
                        </div>
                        <button onclick="window.location.href='<?php echo e(route('instructor.students')); ?>'" class="mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition-colors">
                            View All Students
                        </button>
                    </div>
                        ...
                        <div class="flex-grow">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-medium"><?php echo e($lastSessionDate); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">Present</span>
                                    <span class="font-medium text-green-600"><?php echo e($presentToday); ?></span>
                                </div>
                            </div>
                        </div>
                        <button onclick="window.location.href='<?php echo e(route('instructor.attendance')); ?>'" class="mt-4 w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg transition-colors">
                            Mark Attendance
                        </button>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 flex flex-col h-full">
                        <div class="flex-grow">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-medium"><?php echo e($upcomingSession['date']); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">Time</span>
                                    <span class="font-medium"><?php echo e($upcomingSession['time']); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-600">Program</span>
                                    <span class="font-medium"><?php echo e($upcomingSession['program']); ?></span>
                                </div>
                                <?php else: ?>
                        ...
                        <?php if($upcomingSession): ?>
                        <button onclick="window.location.href='<?php echo e(route('instructor.attendance')); ?>'" class="mt-4 w-full bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-lg transition-colors">
                            View Schedule
                        </button>
                        <?php else: ?>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $recentEnrolledStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm font-medium text-gray-900"><?php echo e(ucfirst($enrollment->user->name)); ?></div>
                                                    <div class="text-sm text-gray-500"><?php echo e($enrollment->user->email); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="<?php echo e(route('instructor.students.view', $enrollment->id)); ?>" class="text-blue-600 hover:text-blue-900">View</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
...
<?php /**PATH C:\Users\gucor\OneDrive\Documents\Herd\Modular_System\resources\views/Instructor/dashboard.blade.php ENDPATH**/ ?>