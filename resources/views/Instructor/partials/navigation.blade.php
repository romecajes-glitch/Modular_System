...
<div class="flex-1 overflow-y-auto">
    <ul class="py-2 space-y-1">
        <!-- Dashboard -->
        <li style="cursor: pointer;" id="dashboardNav" data-url="{{ route('instructor.dashboard') }}" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] {{ request()->is('instructor/dashboard') ? 'active-nav' : '' }}">
        ...
        <!-- Students -->
        <li style="cursor: pointer;" id="studentsNav" data-url="{{ route('instructor.students') }}" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] {{ request()->is('instructor/students*') ? 'active-nav' : '' }}">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <!-- Attendance -->
        <li style="cursor: pointer;" id="attendanceNav" data-url="{{ route('instructor.attendance') }}" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] {{ request()->is('instructor/attendance*') ? 'active-nav' : '' }}">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
        ...
        <!-- Certificate -->
        <li style="cursor: pointer;" id="certificateNav" data-url="{{ route('instructor.certificates') }}" class="nav-item group px-4 py-3 flex items-center transition-all duration-300 rounded-lg mx-2 hover:bg-blue-600/20 hover:shadow-md hover:scale-[1.02] {{ request()->is('instructor/certificates*') ? 'active-nav' : '' }}">
            <div class="nav-icon-container w-8 h-8 flex items-center justify-center bg-blue-700/30 group-hover:bg-blue-500 group-hover:shadow-lg rounded-full transition-all duration-300">
