                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm font-medium text-gray-900">{{ ucwords($enrollment->full_name) }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <button data-student-id="{{ $enrollment->id }}" class="view-details-btn text-blue-600 hover:text-blue-900">View Details</button>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
