...
<body class="bg-gray-100 font-sans">
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-4">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center space-x-3">
                                                    <div class="w-10 h-10 rounded-full overflow-hidden">
                                                        @if($student->photo)
                                                            <img src="{{ asset('storage/' . $student->photo) }}" alt="Profile Photo" class="w-10 h-10 object-cover rounded-full">
                                                        @else
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                ...
                                                <div class="flex flex-col">
                                                    ...
                                                    @if($student->scheduled_deletion_at)
                                                    <span class="text-xs text-red-600 countdown-timer" data-deletion-date="{{ $student->scheduled_deletion_at->toISOString() }}">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <button class="text-blue-600 hover:text-blue-900 mr-2 edit-user-btn" data-user-id="{{ $student->id }}" data-user-type="student">
                        ...
                        <div id="instructorsTable" class="hidden">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center space-x-3">
                                                    <div class="w-10 h-10 rounded-full overflow-hidden">
                                                        @if($instructor->photo)
                                                            <img src="{{ asset('storage/' . $instructor->photo) }}" alt="Profile Photo" class="w-10 h-10 object-cover rounded-full">
                                                        @else
                                                    ...
                                                    <div class="text-sm font-medium text-gray-900">{{ ucwords($instructor->name) }}</div>
                                                </div>
                                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $instructor->email }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $instructor->program->name ?? 'No Program' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    @if($instructor->scheduled_deletion_at)
                                    <span class="text-xs text-red-600 countdown-timer" data-deletion-date="{{ $instructor->scheduled_deletion_at->toISOString() }}">
                                        Deleting in: <span class="font-semibold">-- days</span>
                                    </span>
                                    @endif
                                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <button class="text-blue-600 hover:text-blue-900 mr-2 edit-user-btn" data-user-id="{{ $instructor->id }}" data-user-type="instructor">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                            </td>
                        </tr>
    ...
    @include('Admin.instructor_modal')
    ...
    <script>
        ...
        function refreshInstructorList() {
            ...
            fetch('{{ route("admin.users") }}?search=' + encodeURIComponent(searchTerm), {
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
