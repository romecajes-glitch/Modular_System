        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <img src="{{ asset('pictures/bnc_welc.jpg') }}" alt="School Building" class="w-full h-48 sm:h-56 lg:h-64 object-cover">
                </div>
                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <img src="{{ asset('pictures/comlab.jpg') }}" alt="Classroom" class="w-full h-48 sm:h-56 lg:h-64 object-cover">
                </div>
                <div class="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 sm:col-span-2 lg:col-span-1">
                    <img src="{{ asset('pictures/hallway.jpg') }}" alt="Library" class="w-full h-48 sm:h-56 lg:h-64 object-cover">
                </div>
            </div>
        </div>
    </div>
