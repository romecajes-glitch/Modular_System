...
<body class="bg-gray-50 font-sans">
    ...
    <div class="min-h-screen py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
        <h2 class="zoom-responsive font-bold text-center text-blue-900 mb-8 sm:mb-12">Our Academic Programs</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                <div class="h-40 sm:h-48 bg-blue-100 flex items-center justify-center">
                    <i class="fas fa-car text-4xl sm:text-6xl text-blue-600"></i>
                </div>
                <div class="p-4 sm:p-6">
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Driving with Basic Troubleshooting</h3>
                    <p class="text-sm sm:text-base text-gray-600 mb-4">Learn safe driving techniques and basic vehicle troubleshooting.</p>
                    <a href="#" class="text-blue-600 font-medium hover:text-blue-800 flex items-center text-sm sm:text-base">
            ...
            <!-- Welding -->
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                <div class="h-40 sm:h-48 bg-orange-100 flex items-center justify-center">
                    <i class="fas fa-fire text-4xl sm:text-6xl text-orange-600"></i>
                </div>
                <div class="p-4 sm:p-6">
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Shielded Metal Arc Welding and Fabrication</h3>
                    <p class="text-sm sm:text-base text-gray-600 mb-4">Master welding techniques and metal fabrication skills.</p>
                    <a href="#" class="text-blue-600 font-medium hover:text-blue-800 flex items-center text-sm sm:text-base">
                        Learn more <i class="fas fa-chevron-right ml-1"></i>
                    </a>
                </div>
            ...
            <!-- Electrical -->
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition duration-300">
                <div class="h-40 sm:h-48 bg-yellow-100 flex items-center justify-center">
                    <i class="fas fa-bolt text-4xl sm:text-6xl text-yellow-600"></i>
                </div>
                <div class="p-4 sm:p-6">
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Electrical Installation</h3>
                    <p class="text-sm sm:text-base text-gray-600 mb-4">Learn proper electrical wiring and installation techniques.</p>
                    <a href="#" class="text-blue-600 font-medium hover:text-blue-800 flex items-center text-sm sm:text-base">
                        Learn more <i class="fas fa-chevron-right ml-1"></i>
                    </a>
                </div>
            ...
            <!-- Computer -->
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition duration-300 sm:col-span-2 lg:col-span-1">
                <div class="h-40 sm:h-48 bg-green-100 flex items-center justify-center">
                    <i class="fas fa-laptop text-4xl sm:text-6xl text-green-600"></i>
                </div>
                <div class="p-4 sm:p-6">
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 text-gray-800">Computer Basic Literacy</h3>
                    <p class="text-sm sm:text-base text-gray-600 mb-4">Develop fundamental computer skills for work and daily life.</p>
                    <a href="#" class="text-blue-600 font-medium hover:text-blue-800 flex items-center text-sm sm:text-base">
                        Learn more <i class="fas fa-chevron-right ml-1"></i>
                    </a>
                </div>
