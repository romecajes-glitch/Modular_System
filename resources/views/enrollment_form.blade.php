...
<body class="bg-gray-50 font-sans">
    ...
    <nav class="bg-gradient-to-b from-blue-900 to-blue-600 shadow-md sticky top-0 z-50">
            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex-shrink-0 flex items-center logo-container">
                    <div class="flex items-center">
                        <img src="{{ asset('pictures/logo.png') }}" alt="BNSC Logo" class="h-10 w-10 mr-3">
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-6 xl:space-x-8">
                    <a href="{{ route('welcome')}}" class="nav-link text-white hover:text-blue-300 px-2 xl:px-3 py-2 text-sm font-medium">Home</a>
                    <a href="{{ route('about') }}" class="nav-link text-white hover:text-blue-300 px-2 xl:px-3 py-2 text-sm font-medium">About</a>
                    <a href="{{ route('programs') }}" class="nav-link text-white hover:text-blue-300 px-2 xl:px-3 py-2 text-sm font-medium">Programs</a>
                </div>
        ...
        <div class="lg:hidden hidden" id="mobile-menu">
            <div class="px-4 pt-2 pb-3 space-y-1 bg-gradient-to-b from-blue-900 to-blue-600 border-t border-blue-700">
                <a href="{{ route('welcome')}}" class="block px-3 py-3 rounded-md text-base font-medium text-white hover:text-blue-300 hover:bg-blue-800 transition-colors duration-200">Home</a>
                <a href="{{ route('about') }}" class="block px-3 py-3 rounded-md text-base font-medium text-white hover:text-blue-300 hover:bg-blue-800 transition-colors duration-200">About</a>
                <a href="{{ route('programs') }}" class="block px-3 py-3 rounded-md text-base font-medium text-white hover:text-blue-300 hover:bg-blue-800 transition-colors duration-200">Programs</a>
                ...
                <form id="enrollment-form" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="first-name" name="first_name" value="{{ isset($enrollment) ? $enrollment->first_name : '' }}" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <input type="text" id="last-name" name="last_name" value="{{ isset($enrollment) ? $enrollment->last_name : '' }}" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="text-red-600 text-sm mt-1 error-message"></p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="middle-name" name="middle_name" value="{{ isset($enrollment) ? $enrollment->middle_name : '' }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="text-red-600 text-sm mt-1 error-message"></p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="suffix-name" name="suffix_name" value="{{ isset($enrollment) ? $enrollment->suffix_name : '' }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="text-red-600 text-sm mt-1 error-message"></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" id="birthdate" name="birthdate" value="{{ isset($enrollment) ? $enrollment->birthdate : '' }}" max="{{ date('Y-m-d') }}" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        <p class="text-red-600 text-sm mt-1 error-message"></p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="age" name="age" value="{{ isset($enrollment) ? $enrollment->age : '' }}" readonly class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <p class="text-red-600 text-sm mt-1 error-message"></p>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <option value="Male" {{ (isset($enrollment) && $enrollment->gender === 'Male') ? 'selected' : '' }}>Male</option>
                                <option value="Female" {{ (isset($enrollment) && $enrollment->gender === 'Female') ? 'selected' : '' }}>Female</option>
                            </select>
                            <p class="text-red-600 text-sm mt-1 error-message"></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ isset($enrollment) ? $enrollment->email : '' }}" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        <p class="text-red-600 text-sm mt-1 error-message"></p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone" value="{{ isset($enrollment) ? $enrollment->phone : '' }}" maxlength="11" pattern="[0-9]{11}" inputmode="numeric" placeholder="09123456789" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        <p class="text-red-600 text-sm mt-1 error-message"></p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="address" name="address" value="{{ isset($enrollment) ? $enrollment->address : '' }}" 
                    ...
                    <div>
                        ...
                        <select id="program" name="program_id" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <option value="{{ $program->id }}" {{ (isset($enrollment) && $enrollment->program_id == $program->id) ? 'selected' : '' }}>{{ $program->name }}</option>
                            @endforeach
                        </select>
                        <p class="text-red-600 text-sm mt-1 error-message"></p>
                    </div>
    ...
    <script>
        ...
        function submitEnrollmentForm(form, btn, spinner, btnText) {
            ...
            const isReapplication = {{ isset($enrollment) ? 'true' : 'false' }};
            const enrollmentId = {{ isset($enrollment) ? $enrollment->id : 'null' }};
        ...
        const loginForm = document.querySelector('form[action="{{ route('custom.login') }}"]');
        if (loginForm) {
