...
<body class="bg-gray-100 font-sans">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="content-area flex-1 overflow-y-auto">
            ...
            <div class="p-6">
                                ...
                                <div class="grid gap-6">
                                    ...
                                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
                                        <div class="flex items-center justify-between">
                                            <div class="flex-1">
                                                <h3 class="text-xl font-bold text-gray-800 mb-2">{{ $certificate->enrollment->program->name ?? 'Program Certificate' }}</h3>
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-gray-800">{{ $certificate->instructor_name }}</p>
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="flex space-x-3 ml-6">
                                                <button onclick="viewCertificate({{ $certificate->id }})" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors flex items-center">
                                                    <i class="fas fa-eye mr-2"></i> View
                                                </button>
                                                <button onclick="downloadCertificate({{ $certificate->id }})" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors flex items-center">
                ...
                @elseif($enrollment && $enrollment->isEligibleForCertificate())
    ...
    <script>
        ...
        function viewCertificate(certificateId) {
            ...
            fetch(`/admin/student-certificates/{{ auth()->user()->id }}`)
