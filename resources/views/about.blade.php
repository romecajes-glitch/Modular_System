...
<head>
    ...
    <title>About - BNSC Modular Class Portal</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <!-- Modular Classes Section -->
    <section class="py-12 sm:py-16 lg:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12">
                <h2 class="zoom-responsive font-bold text-gray-800 mb-4 sm:mb-6">About Our Modular Classes</h2>
                <div class="max-w-4xl mx-auto">
                    <p class="zoom-responsive-sub text-gray-700 mb-4 sm:mb-6 leading-relaxed">
                        At Bohol Northern Star College, our modular classes offer a flexible and self-paced learning approach designed to accommodate students with diverse schedules and learning needs. These competency-based programs allow you to master practical skills at your own pace while receiving guidance from our expert instructors.
                    </p>
                    <p class="zoom-responsive-sub text-gray-700 leading-relaxed">
                        Each module focuses on specific competencies, combining theoretical knowledge with hands-on training. Students receive comprehensive learning materials, complete assessments, and demonstrate skills mastery before progressing to the next module. This approach ensures thorough understanding and practical application of each concept.
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                    <div class="text-blue-600 mb-3 sm:mb-4 text-center">
                        <i class="fas fa-calendar-alt text-3xl sm:text-4xl"></i>
                    </div>
                    <h3 class="text-lg sm:text-xl font-semibold text-gray-800 text-center mb-2">Flexible Schedule</h3>
                    <p class="text-sm sm:text-base text-gray-600 text-center">Learn at your own pace with scheduled assessments and instructor consultations.</p>
                </div>

                <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                    <div class="text-blue-600 mb-3 sm:mb-4 text-center">
                        <i class="fas fa-hands-helping text-3xl sm:text-4xl"></i>
                    </div>
                    <h3 class="text-lg sm:text-xl font-semibold text-gray-800 text-center mb-2">Hands-on Training</h3>
                    <p class="text-sm sm:text-base text-gray-600 text-center">Practical skills development with industry-standard equipment and facilities.</p>
                </div>

                <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 sm:col-span-2 lg:col-span-1">
                    <div class="text-blue-600 mb-3 sm:mb-4 text-center">
                        <i class="fas fa-certificate text-3xl sm:text-4xl"></i>
                    </div>
                    <h3 class="text-lg sm:text-xl font-semibold text-gray-800 text-center mb-2">Competency-Based</h3>
                    <p class="text-sm sm:text-base text-gray-600 text-center">Progress upon demonstrating mastery of each skill module.</p>
                </div>
            </div>
        </div>
    </section>
